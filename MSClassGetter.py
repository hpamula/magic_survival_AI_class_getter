...
between_clicking_LOAD_and_Return = 2.5
between_clicking_SAVE_and_Return = 3
between_clicking_Return_after_LOAD_and_Shop = 10.5
between_clicking_Return_after_SAVE_and_Shop = 0
waiting_for_class_image_to_set_its_colors = 1
...
try:
  ...
  def click2():
    ...
    pyautogui.click(left_edge + 1.9491 * width, top_edge + 2.8777 * height) #click "save" in v0.88 as 2 new languages were added
    pyautogui.click(left_edge + 1.25 * width, top_edge + 2.5855 * height) #click "Run"
  ...
  print(e)
  print("Something went wrong. Waiting 1 minute to give you time to read error messages above.")
  sleep(60)
else:
  print("MSClassGetter ended without errors.")
  sleep(3)
